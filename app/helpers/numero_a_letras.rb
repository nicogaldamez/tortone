# https://gist.github.com/efrenfuentes/3785645#file-numero_a_letras-rb
module NumeroALetras
  ...
  module InstanceMethods
    ...
    def a_letras
      ...
      if(parte_decimal > 9)
        letras_decimal = self.kind_of?(Float) ? " con #{parte_decimal.a_letras}" : ''
      else
        letras_decimal = self.kind_of?(Float) ? " con cero #{parte_decimal.a_letras}" : ''
      end
